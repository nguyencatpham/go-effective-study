...
[![Go Report Card](https://goreportcard.com/badge/gitlab.com/nguyencatpham/go-effective-study)](https://goreportcard.com/report/gitlab.com/nguyencatpham/go-effective-study)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://gitlab.com/nguyencatpham/go-effective-study-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/gitlab.com/nguyencatpham/go-effective-study` to `$GOPATH/github.com/author/project` and do a global replacement of the string `gitlab.com/nguyencatpham/go-effective-study` with `github.com/author/project`.

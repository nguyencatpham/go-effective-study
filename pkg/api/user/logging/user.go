...
// Create logging
func (ls *LogService) Create(c echo.Context, req model.User) (resp *model.User, err error) {
...
// List logging
func (ls *LogService) List(c echo.Context, req *model.Pagination) (resp []model.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
// View logging
func (ls *LogService) View(c echo.Context, req int) (resp *model.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
